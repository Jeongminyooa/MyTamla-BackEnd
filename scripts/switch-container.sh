...
echo "> Start health check of Spring boot App at 'http://127.0.0.1:${TARGET_PORT}'..."
...
do
    ...
    if [ ${RESPONSE_CODE} -eq 200 ]; then
        echo "> New Springboot App successfully running"
        echo "> Close Old Springboot App"

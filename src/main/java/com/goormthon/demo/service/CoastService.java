...
public class CoastService {
    ...
    public CoastType calculateCoastResult(SurveyRequest req) {
        ...
        int[][] scoreOfFirst = { {2, 2, 3, 1}, {2, 3, 2, 1}, {3, 1, 2, 3},
                                {1, 1, 3, 2}, {3, 3, 1, 3}, {1, 2, 1, 2} };
        int[][] scoreOfSecond = { {2, 3, 2, 3}, {1, 1, 2, 2}, {3, 2, 3, 2},
                                {1, 1, 3, 3}, {3, 3, 1, 1}, {2, 2, 1, 1} };
        int[][] scoreOfThird = { {2, 1, 1, 2}, {1, 1, 2, 1}, {1, 3, 3, 3},
                                {2, 3, 2, 3}, {3, 2, 3, 2}, {3, 2, 1, 1} };
        int[][] scoreOfFourth = { {2, 2, 3, 1}, {1, 1, 2, 1}, {3, 3, 2, 2},
                                {2, 2, 1, 3}, {1, 1, 3, 3}, {3, 3, 1, 2} };
        int[][] scoreOfFifth = { {2, 2, 2, 3}, {2, 2, 3, 1}, {3, 3, 1, 2},
                                {3, 3, 2, 3}, {1, 1, 1, 2}, {1, 1, 3, 1} };
        int[][] scoreOfSixth = { {2, 3, 3, 1}, {3, 2, 2, 3}, {1, 1, 1, 1}, {1, 1, 1, 2} };
        int[][] scoreOfSeventh = { {1, 2, 2, 1}, {3, 3, 1, 1}, {1, 1, 3, 3},
